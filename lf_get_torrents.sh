...
# Скрипт сакчивает RSS-ленту с новыми торрентами с lostfilm.tv, выбирает из ленты нужные сериалы
...
lf_cookie="Cookie: uid=3291062; usess=ab63993ac00f9e1ee19dbe7b0b3bac9b" # данные для аутентификации на lostfilm
